...
//  brainwallet
//
//  Created by Kerry Washington on 16/05/2025.
...
struct SettingsRowExpandableView_Previews: PreviewProvider {
    static var previews: some View {
        SettingsRowExpandableView(title: "TEST TITLE", detail: "boo bop", expandedHeight: .constant(80))
    }
}
