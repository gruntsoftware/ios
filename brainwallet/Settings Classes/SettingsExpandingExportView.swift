//
//  SettingsExpandingExportView.swift
//  brainwallet
//
...
struct SettingsExpandingExportView: View {

    @ObservedObject
    var viewModel: NewMainViewModel
    @Binding
    var shouldExpandExport: Bool
    ...
    init(title: String, viewModel: NewMainViewModel, shouldExpandExport: Binding <Bool>) {
        self.title = title
        _shouldExpandExport = shouldExpandExport
                                    ...
                                    VStack {
                                        HStack {
                                            Image(systemName: "chevron.right")
                                                ...
                                                .foregroundColor(BrainwalletColor.content)
                                                .rotationEffect(Angle(degrees: shouldExpandExport ? 90 : 0))
                                        }
                                    }
