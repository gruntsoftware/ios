...
extension BWAPIClient {
    ...
    func fetchMoonPayFiatLimits(code: String, completion: @escaping (Result<String, Error>) -> Void) {
        
    }
    func fetchMoonPayBuyQuote(completion: @escaping (Result<String, Error>) -> Void) {
        
    }
    
    func fetchMoonPaySignedURL(completion: @escaping (Result<String, Error>) -> Void) {
