...
enum S {
    enum CreateStep {
        enum MainTitle {
            static let intro = Localization(key: "MainTitle.intro", value: "Quick Start", comment: "Brainwallet Quick Start")
        ...
        enum ExtendedMessage {
            ...
            static let checkboxes = Localization(key: "ExtendedMessage.checkboxes", value: "Enter your email to get updates about Brainwallet", comment: "Email sign up website")
    ...
    enum Send {
        ...
        static let cameraUnavailableTitle = Localization(key: "Send.cameraUnavailableTitle", value: "Brainwallet is not allowed to access the camera", comment: "Camera not allowed alert title")
    ...
    enum JailbreakWarnings {
        ...
        static let messageWithBalance = Localization(key: "JailbreakWarnings.messageWithBalance", value: "DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access Brainwallet's keychain data and steal your Litecoin! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
        static let messageWithoutBalance = Localization(key: "JailbreakWarnings.messageWithoutBalance", value: "DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access Brainwallet's keychain data and steal your Litecoin. Please only use Brainwallet on a non-jailbroken device.", comment: "Jailbreak warning message")
    ...
    enum UnlockScreen {
        ...
        static let touchIdPrompt = Localization(key: "UnlockScreen.touchIdPrompt", value: "Unlock your Brainwallet.", comment: "TouchID/FaceID prompt text")
    ...
    enum SecurityCenter {
        ...
        enum Cells {
            ...
            static let pinDescription = Localization(key: "SecurityCenter.pinDescription", value: "Protects your Brainwallet from unauthorized users.", comment: "PIN button description")
            static let touchIdTitle = Localization(key: "SecurityCenter.touchIdTitle", value: "Touch ID", comment: "Touch ID button title")
            static let touchIdDescription = Localization(key: "SecurityCenter.touchIdDescription", value: "Conveniently unlock your Brainwallet and send money up to a set limit.", comment: "Touch ID/FaceID button description")
    ...
    enum UpdatePin {
        ...
        static let createInstruction = Localization(key: "UpdatePin.createInstruction", value: "Your PIN will be used to unlock your Brainwallet and send money.", comment: "PIN creation info.")
    ...
    enum RecoverWallet {
        ...
        static let intro = Localization(key: "RecoverWallet.intro", value: "Recover your Brainwallet with your paper key.", comment: "Recover wallet intro")
    ...
    enum AccountHeader {
        static let defaultWalletName = Localization(key: "AccountHeader.defaultWalletName", value: "My Brainwallet", comment: "Default wallet name")
    ...
    enum TouchIdSettings {
        ...
        static let label = Localization(key: "TouchIdSettings.label", value: "Use your fingerprint to unlock your Brainwallet and send money up to a set limit.", comment: "Touch Id screen label")
        static let switchLabel = Localization(key: "TouchIdSettings.switchLabel", value: "Enable Touch ID for Brainwallet", comment: "Touch id switch label.")
    ...
    enum FaceIDSettings {
        ...
        static let label = Localization(key: "FaceIDSettings.label", value: "Use your face to unlock your Brainwallet and send money up to a set limit.", comment: "Face ID screen label")
        static let switchLabel = Localization(key: "FaceIDSettings.switchLabel", value: "Enable Face ID for Brainwallet", comment: "Face id switch label.")
    ...
    enum Settings {
        ...
        static let enjoying = Localization(key: "Settings.enjoying", value: "Are you enjoying Brainwallet?", comment: "Are you enjoying Brainwallet alert message body")
        ...
        static let brainwalletVersion = Localization(key: "Settings.brainwallet.version", value: "Brainwallet Version:", comment: "Brainwallet version")
        static let brainwalletEnvironment = Localization(key: "Settings.brainwallet.environment", value: "Brainwallet Environment:", comment: "Brainwallet environment")
        static let socialLinks = Localization(key: "Settings.socialLinks", value: "Social Links:", comment: "Brainwallet Social links")
    ...
    enum ReScan {
        ...
        static let body2 = Localization(key: "ReScan.body2", value: "If a transaction shows as completed on the Litecoin network but not in your Brainwallet.", comment: "Syncing explanation")
    ...
    enum ShareData {
        ...
        static let body = Localization(key: "ShareData.body", value: "Help improve Brainwallet by sharing your anonymous data with us. This does not include any financial information. We respect your financial privacy.", comment: "Share data view body")
    ...
    enum Prompts {
        ...
        enum PaperKey {
            ...
            static let body = Localization(key: "Prompts.PaperKey.body", value: "Your Paper Key must be kept in a safe place. It is the only way modify or restore your Brainwallet or transfer your Litecoin. Please write it down.", comment: "Warning about paper key.")
        }
        
        enum SetPin {
            static let title = Localization(key: "Prompts.SetPin.title", value: "Set PIN", comment: "Set PIN prompt title.")
            static let body = Localization(key: "Prompts.SetPin.body", value: "Brainwallet requires a 6-digit PIN. Please set and store your PIN in a safe place.", comment: "Upgrade PIN prompt body.")
        }
        ...
        enum ShareData {
            ...
            static let body = Localization(key: "Prompts.ShareData.body", value: "Help improve Brainwallet by sharing your anonymous data with us", comment: "Share data prompt body")
        }
    ...
    enum LocationPlugin {
        ...
        static let notAuthorized = Localization(key: "LocationPlugin.notAuthorized", value: "Brainwallet does not have permission to access location services.", comment: "No permissions for location services")
    }
    ...
    enum Import {
        ...
        static let rightCaption = Localization(key: "Import.rightCaption", value: "Your Brainwallet Wallet", comment: "Caption for graphics")
        static let importMessage = Localization(key: "Import.message", value: "Importing a wallet transfers all the money from your other wallet into your Brainwallet wallet using a single transaction.", comment: "Import wallet intro screen message")
    ...
    enum WipeWallet {
        ...
        static let startMessage = Localization(key: "WipeWallet.startMessage", value: "Starting or recovering another wallet allows you to access and manage a different Brainwallet wallet on this device.", comment: "Start wipe wallet view message")
        ...
        static let resetTitle = Localization(key: "resetTitle", value: " Delete my Brainwallet ", comment: "Warning Empty Wipe title")
        ...
        static let warningDescription = Localization(key: "WipeWallet.warningDescription", value: "Your Brainwallet is empty. Resetting will delete the old private key and wipe the app data.\n\nAfter the reset, be prepared to record the new 12 words and keep them in a very secure place.\n\nNo Brainwallet developers can retrieve this seed for you.", comment: "Warning description")
    ...
    enum Welcome {
        static let title = Localization(key: "Welcome.title", value: "Welcome to Brainwallet", comment: "Welcome view title")
        static let body = Localization(key: "Welcome.body", value: "Brainwallet now has a brand new look and some new features.\n\nAll coins are displayed in lites (ł). 1 Litecoin (Ł) = 1000 lites (ł).", comment: "Welcome view body text")
    }
