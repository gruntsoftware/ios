...
extension UIColor {
	...
	static var brainwalletGray: UIColor { // B8B8B8
		return #colorLiteral(red: 0.7215686275, green: 0.7215686275, blue: 0.7215686275, alpha: 1)
	}

	static var midnight: UIColor { // 0F0853
		return #colorLiteral(red: 0.05882352941, green: 0.03137254902, blue: 0.3254901961, alpha: 1)
	}

	static var grape: UIColor { // 402DAE
		return #colorLiteral(red: 0.2509803922, green: 0.1764705882, blue: 0.6823529412, alpha: 1)
	}

	static var cheddar: UIColor { // FFAE00
		return #colorLiteral(red: 1, green: 0.6823529412, blue: 0, alpha: 1)
	}

	static var pesto: UIColor { // 25AA2C
		return #colorLiteral(red: 0.1450980392, green: 0.6666666667, blue: 0.1725490196, alpha: 1)
	}

	static var chili: UIColor { // CE3025
		return #colorLiteral(red: 0.8078431373, green: 0.1882352941, blue: 0.1450980392, alpha: 1)
	}

	static var brainwalletBlue: UIColor { // 2968F2
		return #colorLiteral(red: 0.1607843137, green: 0.4078431373, blue: 0.9490196078, alpha: 1)
	}
...
extension Color {
    ...
    static var brainwalletGray: Color { // B8B8B8
        return Color(#colorLiteral(red: 0.7215686275, green: 0.7215686275, blue: 0.7215686275, alpha: 1))
    }
	static var cheddar: Color { // FFAE00
		return Color(#colorLiteral(red: 1, green: 0.6823529412, blue: 0, alpha: 1))
	}

	static var pesto: Color { // 25AA2C
		return Color(#colorLiteral(red: 0.09019607843, green: 0.6196078431, blue: 0.1529411765, alpha: 1))
	}
    
    static var midnight: Color { // 0F0853
        return Color(UIColor.midnight)
    }
    
    static var grape: Color { // 402DAE
        return Color(UIColor.grape)
    }
    
    static var chili: Color { // D9E76C
        return Color(UIColor.chili)
    }
}
